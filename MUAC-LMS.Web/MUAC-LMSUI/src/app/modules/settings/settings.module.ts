...
@NgModule({
  declarations: [StudentCreateComponent, StudentDetailsComponent, TeacherCreateComponent, TeacherDetailsComponent, MainCategoryCreateComponent, MainCategoryDetailsComponent, SubCategoryCreateComponent, SubCategoryDetailsComponent, MainCategoryViewComponent, SubCategoryViewComponent, StudentViewComponent, TeacherViewComponent],
